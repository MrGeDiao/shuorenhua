...
这类词不是 AI 套路——AI 检测器测不出它们，模型也未必爱用。它们是**人类旧文风的时代标记**：上世纪报刊散文腔、2000 年代博客腔、2010 年代公众号/管理培训腔。问题出在与锚定语域的错配上：一篇当代第一人称口语文里混进「摆在面前」，突兀感和翻译腔同级，只是方向相反——不是机器味，是旧人类味。

适用条件：主语域锚定为**当代第一人称口语**（个人博客、复盘、帖子）时按 Tier 1 处理；写怀旧题材、年代小说、刻意复古文风时**整节放行**。

判据一句话：**这个词，今天一个一线干活的人聊天发帖还会不会这么说？** 不会，就标。

### 上世纪报刊散文腔（约 1980s–2000s）

- 摆在（我）面前 → 写明实际发生了什么（「没处躲了」比「摆在面前」信息多）
- 头一回 → 第一次
- 反倒 → 反而；多数位置直接删，口语转折用「结果」「没想到」
- 赤裸裸地 → 直接写是什么样
- 蓦然 / 恍然 / 油然 / 不禁 → 删，直接写动作或内容
- 此刻 / 彼时 → 现在 / 那时
- 心中一暖 / 心中一沉 → 写事件本身，或「心里咯噔一下」
- 岁月 / 光阴 → 具体时间跨度
- 不由得 → 忍不住；多数位置直接删

### 2000s 博客 / 2010s 公众号腔

- 写在最后（小标题）→ 事件式标题（「回到开头」）或删掉小标题
- 那些年 → 具体年份
- 与君共勉 / 共勉 → 删，或改成直接陈述
- 满满的（回忆/正能量）→ 写具体内容
- 致敬 → 写明对方做对了什么

### 2010s 管理培训腔（「商业/互联网黑话」节的年代款补充）

- 投入（无宾语，如「要一直投入」）→ 养着、持续做（补上宾语或换口语动词）
- 落地（比喻用法）→ 做出来、上线（技术部署本义放行）
