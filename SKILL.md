---
name: stop-slop-zh
description: 检查和清理中文文本里的 AI 套路，适用于“去 AI 味”“说人话”“自然一点”“别像模板”这类改写需求；按场景控制力度，同时保留事实、术语和语域。
metadata:
  short-description: 去模板感的中文改写协议
---

# stop-slop-zh

把中文文本从“像模型在表演写作”拉回“像具体人在当前场景下表达”。
...
- 需要改写中文 `chat`、`status`、`docs`、`public-writing`
- 需要先判断文本该轻改、中改还是重改
