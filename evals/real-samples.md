...
> v1.7.2 新增。用来补 `benchmark.md` 的短板：benchmark 是合成的、结构清晰、病灶明显；
...
>
> 下一阶段（v1.7.3）会通过 `.github/ISSUE_TEMPLATE/bad-case.md` 征集明确授权的真实样本，追加到本文件。
...
> - 依赖升级：Node 18 → 20
>
> 下一版会做 voice calibration，预计 5 月中旬。
...
>
> 现在覆盖 210+ 中文词条，51 条 benchmark。如果你也在写 AI 会帮你起草的文档、release note、周报，欢迎试试，也欢迎提 bad case。
...
以下 3 条原文病灶密集、场景典型、改写后对比强烈，适合作为 README 示例或后续 release note 素材：
...
- v1.7.3 收集真实 bad case 后，逐条替换 / 追加到本文件，目标 20+ 条
- 替换时保留原 RS 编号，新增从 RS-11 起
- 真实样本必须通过 `bad-case.md` 模板提交，确保有明确授权和上下文
